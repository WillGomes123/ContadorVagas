...
while True:
    ...
    imgDilated = cv2.dilate(imgMedian, kernel)

    vagasAbertas = 0
    for x,y,w,h in vagas:
        vaga = imgDilated[y:y+h, x:x+w]
    ...
    cv2.putText(img, f'LIVRE:{vagasAbertas}/69', (95,45), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255, 255, 255), 2)

    cv2.imshow('video', img)
    cv2.imshow('video Th', imgDilated)
    cv2.waitKey(10)